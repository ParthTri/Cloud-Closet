...
import { View, Text, StyleSheet, Button, Image, Modal, Pressable, Alert, ScrollView } from 'react-native';
...
export default function Upload() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Button title="Upload from Library" onPress={async () => {
        const allPermissions = await requestPermissions();
        if (allPermissions) {
      ...
      <CameraView ref={cameraRef} style={styles.cameraContainer} facing="back" autofocus='on'/>
      ...
      <Modal visible={isModalVisible} transparent={true} animationType="slide" onRequestClose={() => setIsModalVisible(false)}>
        <View style={styles.modalView}>
          ...
          {!isCategorySelectionVisible ? (
            <>
              <Text style={styles.modalText}>Are you happy with this image?</Text>
